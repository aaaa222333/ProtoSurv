...
def get_args_parser():
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='/home/user/prognosis_lst/evaluate_model/ConvNeXt/output/lung1/Resnet/pre/checkpoint-best.pth',
    ...
    parser.add_argument('--column_names', type=str, default="feature_path",
                        help='特征文件路径的列名')
    parser.add_argument('--labels_name', type=str, default="feature_path",
                        help='特征文件路径的列名')
...
def main(args):
    ...
    mean_acc, lower_ci, upper_ci = calculate_95_ci(df_results)
    
    print(f"准确率 Mean Accuracy: {mean_acc:.4f}")
