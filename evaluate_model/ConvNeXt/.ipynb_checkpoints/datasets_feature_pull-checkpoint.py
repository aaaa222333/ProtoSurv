...
from datasets import Dataset, DatasetDict, IterableDatasetDict, load_dataset, concatenate_datasets
...
# stats0 = {
#     'mean': 0.675040, 'std': 0.388189, 'q1': 0.682307, 'q3': 0.918124
# }
# stats1 = {
#     'mean': 0.571117, 'std': 0.465969, 'q1': 0.515187, 'q3': 0.880411
# }  # 这是huaxi的
    ...
    def preprocess(examples):
        ...
        for i in range(n_samples):
            ...
            if need_pull and label in feature_center:
                ...
                feature = feature_pull(feature, feature_center[label], sim, th1, th2)
