...
def get_args_parser():
    ...
    parser.add_argument('--labels_name', type=str, default="label",
                        help='标签列名')
    parser.add_argument('--output_dir', default='/home/user/prognosis_lst/evaluate_model/ConvNeXt/output/huaxi/normal',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default="/home/user/prognosis_lst/evaluate_model/ConvNeXt/logs/huaxi/normal",
                        help='path where to tensorboard log')
    parser.add_argument('--pull_strength', default=0.5, type=float,help='pull strength')
...
if __name__ == '__main__':
    ...
    if args.pre_path:
        args.output_dir = os.path.join(args.output_dir, "generate")
        args.log_dir = os.path.join(args.log_dir, "generate")
    else:
        args.output_dir = os.path.join(args.output_dir, "base")
        args.log_dir = os.path.join(args.log_dir, "base")
    if args.output_dir:
