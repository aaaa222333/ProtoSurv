...
from datasets_copy import prepare_dataset
from utils import NativeScalerWithGradNormCount as NativeScaler
import utils
from models import Resnet_1D_easy,Resnet_1D
...
def get_args_parser():
    ...
    parser.add_argument('--train_path', type=str,
                        default="/home/user/prognosis_lst/evaluate_model/ConvNeXt/data/lung1/train/final_complete_with_paths_labels.csv",
                        help='训练集CSV文件路径')
    parser.add_argument('--val_path', type=str,
                        default="/home/user/prognosis_lst/evaluate_model/ConvNeXt/data/lung1/test/final_complete_with_paths_labels.csv",
                        help='验证集CSV文件路径')
    # 数据列名参数
    ...
    parser.add_argument('--labels_name', type=str, default="label",
                        help='标签列名')
    parser.add_argument('--output_dir', default='/home/user/prognosis_lst/evaluate_model/ConvNeXt/output/lung1/Resnet',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default="/home/user/prognosis_lst/evaluate_model/ConvNeXt/logs/lung1/Resnet",
