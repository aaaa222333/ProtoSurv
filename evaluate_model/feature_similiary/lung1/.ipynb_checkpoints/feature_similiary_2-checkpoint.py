...
def get_args_parser():
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='/home/user/prognosis_lst/evaluate_model/ConvNeXt/output/lung1/sim/checkpoint-best.pth',
                        help='finetune from checkpoint')


    parser.add_argument('--test_path', type=str,
                        default="/home/user/prognosis_lst/evaluate_model/feature_similiary/lung1/pseudo_label_results.csv",
                        help='验证集CSV文件路径')
    # 数据列名参数
